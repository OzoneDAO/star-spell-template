...
import { IForeignControllerLike } from "../interfaces/IForeignControllerLike.sol";
...
library ForeignControllerInit {
        ...
        internal
    {
        ...
        require(IALMProxyLike(controllerInst.almProxy).hasRole(DEFAULT_ADMIN_ROLE, checkAddresses.admin),     "ForeignControllerInit/incorrect-admin-almProxy");
        require(IRateLimitsLike(controllerInst.rateLimits).hasRole(DEFAULT_ADMIN_ROLE, checkAddresses.admin), "ForeignControllerInit/incorrect-admin-rateLimits");
        ...
        private
    {
        ...
        IForeignControllerLike newController = IForeignControllerLike(controllerInst.controller);
